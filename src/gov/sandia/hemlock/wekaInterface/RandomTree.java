...
/**
 * Wrapper for Weka Random Tree algorithm.
 *
 * @author Sean A. Gilpin
 */
public class RandomTree implements Model
{
	public weka.classifiers.trees.RandomTree wekaRT;
	...
	{
		wekaRT = new weka.classifiers.trees.RandomTree();
		wekaRT.setOptions(WekaParameterTranslator.translate(modelParameters));
		wekaRT.buildClassifier(dataSet.records);
	...
	public double getTargetValue(double[] record) throws Exception
	{
		...
		return wekaRT.classifyInstance(instance);
	}
	...
	public double[] getTargetDistribution(double[] record) throws Exception
	{
		Instance instance = new Instance(1.0, record);
		instance.setDataset(dataSet.records);
		return wekaRT.distributionForInstance(instance);
	}

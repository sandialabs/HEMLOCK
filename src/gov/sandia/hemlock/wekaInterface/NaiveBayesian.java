...
/**
 * Wrapper for Weka NaiveBayesian algorithm.
 *
 * @author Sean A. Gilpin
 */
public class NaiveBayesian implements Model
{

	public weka.classifiers.bayes.NaiveBayes wekaNBModel;
	...
	{
		wekaNBModel = new weka.classifiers.bayes.NaiveBayes();
		wekaNBModel.setOptions(WekaParameterTranslator.translate(modelParameters));
		wekaNBModel.buildClassifier(dataSet.records);
	...
	public double getTargetValue(double[] record) throws Exception
	{
		...
		return wekaNBModel.classifyInstance(instance);
	}
	...
	public double[] getTargetDistribution(double[] record) throws Exception
	{
		...
		Instance instance = new Instance(1.0, record);
		instance.setDataset(dataSet.records);
		return wekaNBModel.distributionForInstance(instance);
	}
	...
	{
		return ModelType.NaiveBayesian;
	}

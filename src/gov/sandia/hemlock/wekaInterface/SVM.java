...
/**
 * Wrapper for Weka SMO algorithm.
 *
 * @author Sean A. Gilpin
 */
public class SVM implements Model
{
	public weka.classifiers.functions.SMO wekaSVM;
	...
	{
		wekaSVM = new weka.classifiers.functions.SMO();
		wekaSVM.setOptions(WekaParameterTranslator.translate(modelParameters));
		wekaSVM.buildClassifier(dataSet.records);
		//get rid of training dataSet
	...
	public double getTargetValue(double[] record) throws Exception
	{
		...
		return wekaSVM.classifyInstance(instance);
	}
	...
	public double[] getTargetDistribution(double[] record) throws Exception
	{
		Instance instance = new Instance(1.0, record);
		instance.setDataset(dataSet.records);
		return wekaSVM.distributionForInstance(instance);
	}
	...
	{
		return ModelType.KNearestNeighbor;
	}
}

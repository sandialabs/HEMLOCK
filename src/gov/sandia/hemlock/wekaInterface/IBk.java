...
/**
 * Wrapper for Weka IBK algorithm.
 *
 * @author Sean A. Gilpin
 */
public class IBk implements Model
{
	public weka.classifiers.lazy.IBk wekaIBk;
	...
	{
		wekaIBk = new weka.classifiers.lazy.IBk();
		wekaIBk.setOptions(WekaParameterTranslator.translate(modelParameters));
		wekaIBk.buildClassifier(dataSet.records);
	...
	public double getTargetValue(double[] record) throws Exception
	{
		...
		return wekaIBk.classifyInstance(instance);
	}
	...
	public double[] getTargetDistribution(double[] record) throws Exception
	{
		Instance instance = new Instance(1.0, record);
		instance.setDataset(dataSet.records);
		return wekaIBk.distributionForInstance(instance);
	}

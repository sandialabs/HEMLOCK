...
/**
 * Specifies parameters for building a Naive Bayesian classifier.
 *  
 * @author Sean A. Gilpin
 */
public class NaiveBayesianParameters extends ModelParameters
{
	/**
	 ...
	 *	model.
	 */
	public NaiveBayesianParameters(FrameworkType frameworkType)
	{
		super(frameworkType, ModelType.NaiveBayesian);
	}
	 ...
	 */
	public NaiveBayesianParameters(FrameworkType frameworkType, Hashtable<String,String> parameters)
	{
		this(frameworkType);
	}
}

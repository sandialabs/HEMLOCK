...
/**
 * Specifies parameters for building a Sum Rule Ensemble classifier.
 *  
 * @author Sean A. Gilpin
 */

public class SumRuleParameters extends EnsembleParameters
{
	 ...
	 *	model.
	 */
	public SumRuleParameters(FrameworkType frameworkType)
	{
		super(frameworkType, ModelType.SumRule);
	}
	 ...
	 */
	public SumRuleParameters(FrameworkType frameworkType, Hashtable<String,String> parameters)
	{
		this(frameworkType);
